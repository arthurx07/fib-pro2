...
public:
  ...
  class iterator {
    ...
    {
      if (not reverse and pitem == &(plist->itemsup)) reverse = true;
      else if (reverse and pitem == plist->iteminf.next) reverse = false;
      else if (reverse) pitem = pitem->prev;
    ...
    /* Post: el p.i apunta a l'element anterior a E,
       el resultat és el p.i. */
    {
      if (not reverse and pitem == plist->iteminf.next) reverse = true;
      else if (reverse and pitem == &(plist->itemsup)) reverse = false;
      else if (reverse) pitem = pitem->next;
