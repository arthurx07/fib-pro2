  ...
  class iterator {
       ...
       el resultat és el p.i. */
    {
      if (pitem != &(plist->itemsup)) {
        if (not avoiding or avoided_iterator->pitem != pitem->next)
          pitem = pitem->next;
      }
      return *this;
    }
       ...
       el resultat és el p.i. */
    {
      if (pitem != plist->iteminf.next) {
        if (not avoiding or avoided_iterator->pitem != pitem->prev)
          pitem = pitem->prev;
      }
      return *this;
    }
