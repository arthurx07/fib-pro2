...
public:
  ...
  class iterator {
       ...
       el resultat és el p.i. */
    {
      ...
      if (entangled and entangled_iter->pitem != &(entangled_iter->plist->itemsup)) {
        entangled_iter->pitem = entangled_iter->pitem->next;
      }
      return *this;
    }
       ...
       el resultat és el p.i. */
    {
      ...
      if (entangled and entangled_iter->pitem != entangled_iter->plist->iteminf.next) {
        entangled_iter->pitem = entangled_iter->pitem->prev;
      }
      return *this;
    }
