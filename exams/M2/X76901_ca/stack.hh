...
public:
  ...
  void push(T value) {
    ...
    if (entangled)
    {
      Item *pnewitem_entangled = new Item();
      pnewitem_entangled->value = value;
      pnewitem_entangled->next = entangled_stack->ptopitem;
      entangled_stack->ptopitem = pnewitem_entangled;
      entangled_stack->_size++;
    }
  }
